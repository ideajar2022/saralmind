                ...
                <table class="table table-bordered">
                  ...
                  @foreach($subjects as $key=>$subject)
                    <tr id="table-row-{{ $subject->id }}">
                        ...
                        <td>
                          <a href="{{ route('subject.restore',$subject->id)}}" class="badge bg-primary restore-confirm"><i class="fa fa-trash-restore" data-toggle="tooltip" data-placement="top" title="Restore"></i></a>
                          <a href="{{ route('subject.permanent-delete',$subject->id)}}" class="badge bg-danger permanent-delete-confirm"><i class="fa fa-trash" data-toggle="tooltip" data-placement="top" title="Delete"></i></a>
                        </td>
                    </tr>
                  @endforeach
                  </tbody>
