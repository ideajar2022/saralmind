                ...
                <table class="table table-bordered">
                  ...
                  @foreach($objectiveQuestions as $key=>$objectiveQuestion)
                    <tr id="table-row-{{ $objectiveQuestion->id }}">
                        ...
                        <td>
                          <a href="{{ route('mcq.restore',$objectiveQuestion->id)}}" class="badge bg-primary restore-confirm"><i class="fa fa-trash-restore" data-toggle="tooltip" data-placement="top" title="Restore"></i></a>
                          <a href="{{ route('mcq.permanent-delete',$objectiveQuestion->id)}}" class="badge bg-danger permanent-delete-confirm"><i class="fa fa-trash" data-toggle="tooltip" data-placement="top" title="Delete"></i></a>
                        </td>
                    </tr>
                  @endforeach
                  </tbody>
