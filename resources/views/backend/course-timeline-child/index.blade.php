      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6 text-right">
            ...
            <a href="{{route('study-period-child.trash')}}" class="badge bg-primary top-add-btn"><i class="fa fa-eye" title="View Trashed"></i></a>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
                ...
                <table class="table table-bordered">
                  ...
                  @foreach($studyPeriodChilds as $key=>$studyPeriodChild)
                    <tr id="table-row-{{ $studyPeriodChild->id }}">
                        ...
                        <td>
                          <a href="{{ route('study-period-child.edit',$studyPeriodChild->id) }}" class="badge bg-primary"><i class="fas fa-edit"></i></a>
                          <a href="{{ route('study-period-child.destroy',$studyPeriodChild->id)}}" class="badge bg-danger delete-confirm"><i class="fa fa-trash" data-toggle="tooltip" data-placement="top" title="Delete"></i></a>
                        </td>
                    </tr>
                  @endforeach
                  </tbody>
