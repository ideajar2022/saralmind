      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6 text-right">
            <a href="{{route('lesson.import')}}"><button type="submit" class="btn btn-primary btn-sm">Import Lesson</button></a>
            <a href="{{route('lesson.create')}}" class="badge bg-success top-add-btn"><i class="fa fa-plus" title="Add Lesson"></i></a>
            <a href="{{route('lesson.trash')}}" class="badge bg-primary top-add-btn"><i class="fa fa-eye" title="View Trashed"></i></a>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
                ...
                <table class="table table-bordered">
                  ...
                  @foreach($lessons as $key=>$lesson)
                    <tr id="table-row-{{ $lesson->id }}">
                        ...
                        <td>
                          <a href="{{ route('lesson.edit',$lesson->id) }}" class="badge bg-primary"><i class="fas fa-edit"></i></a>
                          <a href="{{ route('lesson.destroy',$lesson->id)}}" class="badge bg-danger delete-confirm"><i class="fa fa-trash" data-toggle="tooltip" data-placement="top" title="Delete"></i></a>
                        </td>
                    </tr>
                  @endforeach
                  </tbody>
