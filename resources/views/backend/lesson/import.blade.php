        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form method="POST" action="{{ route('lesson.import') }}" enctype="multipart/form-data" class="form-horizontal">
                  <div class="container-fluid">
                    @csrf
                    <div class="row">
                      <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <select name="faculty_id" class="form-control select2" style="width: 100%;">
                            ...
                            <option value="{{ $key }}" @if(old('faculty_id')==$key) selected @endif>{{ $faculty }}</option>
                            @endforeach
                          </select>
