                ...
                <table class="table table-bordered">
                  ...
                  @foreach($products as $key=>$product)
                    <tr id="table-row-{{ $product->id }}">
                        ...
                        <td>
                           <a href="{{ route('product.restore',$product->id)}}" class="badge bg-primary restore-confirm"><i class="fa fa-trash-restore" data-toggle="tooltip" data-placement="top" title="Restore"></i></a>
                          <a href="{{ route('product.permanent-delete',$product->id)}}" class="badge bg-danger permanent-delete-confirm"><i class="fa fa-trash" data-toggle="tooltip" data-placement="top" title="Delete"></i></a>
                        </td>
                    </tr>
                  @endforeach
                  </tbody>
