        ...
        <div class="card-body">
          ...
          <div class="form-group {{ $errors->has('description')? 'has-danger': '' }}">
            <label for="description" class="control-label">Description</label>
              <textarea name="description" placeholder="Description" class="form-control simpleEditor" rows="4">{{ old('description',$product->description) }}</textarea>
          ...
          <div class="form-group">
            ...
            <select class="form-control select2" name="status">
              ...
              <option value="APPROVED" @if(old('status',$product->status)==='APPROVED') selected @endif>APPROVED</option>
              <option value="UNAPPROVED" @if(old('status',$product->status)==='UNAPPROVED') selected @endif>  UNAPPROVED
              </option>
              <option value="DISAPPROVED" @if(old('status',$product->status)==='DISAPPROVED') selected @endif>DISAPPROVED</option>
            </select>
