              ...
              <div class="card-body">
                <table class="table table-bordered">
                  ...
                  @foreach($bugs as $key=>$bug)
                    <tr id="table-row-{{ $bug->id }}">
                        <td>{{ ($bugs->currentpage()-1) * $bugs->perpage() + $key + 1 }}</td>
                        <td>
                        ...
                        <!-- <td>{{ $bug->status }}</td> -->
                        <td>
                          <a href="{{ route('bug.destroy',$bug->id)}}" class="badge bg-danger delete-confirm"><i class="fa fa-trash" data-toggle="tooltip" data-placement="top" title="Delete"></i></a>
                        </td>
                    </tr>
                  @endforeach
                  </tbody>
