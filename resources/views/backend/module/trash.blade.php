                ...
                <table class="table table-bordered">
                  ...
                  @foreach($modules as $key=>$module)
                    <tr id="table-row-{{ $module->id }}">
                        ...
                        <td>{{ $module->name }}</td>
                        <td>
                          <a href="{{ route('module.restore',$module->id)}}" class="badge bg-primary restore-confirm"><i class="fa fa-trash-restore" data-toggle="tooltip" data-placement="top" title="Restore"></i></a>
                          <a href="{{ route('module.permanent-delete',$module->id)}}" class="badge bg-danger permanent-delete-confirm"><i class="fa fa-trash" data-toggle="tooltip" data-placement="top" title="Delete"></i></a>
                        </td>
                    </tr>
                  @endforeach
                  </tbody>
