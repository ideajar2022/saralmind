                ...
                <table class="table table-bordered">
                  ...
                  @foreach($notes as $key=>$note)
                    <tr id="table-row-{{ $note->id }}">
                        ...
                        <td>{{ $note->status }}</td>
                        <td>
                          <a href="{{ route('note.restore',$note->id)}}" class="badge bg-primary restore-confirm"><i class="fa fa-trash-restore" data-toggle="tooltip" data-placement="top" title="Restore"></i></a>
                          <a href="{{ route('note.permanent-delete',$note->id)}}" class="badge bg-danger permanent-delete-confirm"><i class="fa fa-trash" data-toggle="tooltip" data-placement="top" title="Delete"></i></a>
                        </td>
                    </tr>
                  @endforeach
                  </tbody>
