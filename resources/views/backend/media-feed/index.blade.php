        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6 text-right">
            <a href="{{route('media-feed.create')}}" class="badge bg-success top-add-btn"><i class="fa fa-plus" title="Add Media Feed"></i></a>
             <a href="{{route('media-feed.trash')}}" class="badge bg-primary top-add-btn"><i class="fa fa-eye" title="View Trashed"></i></a>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
                ...
                <table class="table table-bordered">
                  ...
                  @foreach($mediaFeeds as $key=>$mediaFeed)
                    <tr id="table-row-{{ $mediaFeed->id }}">
                        ...
                        <td>
                          <a href="{{ route('media-feed.edit',$mediaFeed->id) }}" class="badge bg-primary"><i class="fas fa-edit"></i></a>
                          <a href="{{ route('media-feed.destroy',$mediaFeed->id)}}" class="badge bg-danger delete-confirm"><i class="fa fa-trash" data-toggle="tooltip" data-placement="top" title="Delete"></i></a>
                        </td>
                    </tr>
                  @endforeach
                  </tbody>
