                ...
                <table class="table table-bordered">
                  ...
                  @foreach($faculties as $key=>$Faculty)
                    <tr id="table-row-{{ $Faculty->id }}">
                        ...
                        <td> 
                          <a href="{{ route('faculty.restore',$faculty->id)}}" class="badge bg-primary restore-confirm"><i class="fa fa-trash-restore" data-toggle="tooltip" data-placement="top" title="Restore"></i></a>
                          <a href="{{ route('faculty.permanent-delete',$faculty->id)}}" class="badge bg-danger permanent-delete-confirm"><i class="fa fa-trash" data-toggle="tooltip" data-placement="top" title="Delete"></i></a>
                        </td>
                    </tr>
                  @endforeach
                  </tbody>
