...
<!-- Content Header (Page header) -->
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Soft Deleted Adversiements</h1>
          </div><!-- /.col -->
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr id="table-row-{{ $advertisement->id }}">
                        ...
                        <td>{{ $advertisement->client_id }}</td>
                        <td>{{ $advertisement->name }}</td>
                        <td>{{ $advertisement->link }}</td>
                        <td>{{ $advertisement->status }}</td>
                        <td>
                          <a href="{{ route('advertisement.restore',$advertisement->id)}}" class="badge bg-primary restore-confirm"><i class="fa fa-trash-restore" data-toggle="tooltip" data-placement="top" title="Restore"></i></a>
                          <a href="{{ route('advertisement.permanent-delete',$advertisement->id)}}" class="badge bg-danger delete-confirm"><i class="fa fa-trash" data-toggle="tooltip" data-placement="top" title="Delete"></i></a>
                        </td>
                    </tr>
                    @endforeach
                  </tbody>
