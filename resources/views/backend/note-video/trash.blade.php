                ...
                <table class="table table-bordered">
                  ...
                  @foreach($noteVideos as $key=>$noteVideo)
                    <tr id="table-row-{{ $noteVideo->id }}">
                        <td>{{ ($noteVideos->currentpage()-1) * $noteVideos->perpage() + $key + 1 }}</td>
                        <td>{{ $noteVideo->title }}</td>
                        ...
                        <td>
                          <a href="{{ route('video.restore',$noteVideo->id)}}" class="badge bg-primary restore-confirm"><i class="fa fa-trash-restore" data-toggle="tooltip" data-placement="top" title="Restore"></i></a>
                          <a href="{{ route('video.permanent-delete',$noteVideo->id)}}" class="badge bg-danger permanent-delete-confirm"><i class="fa fa-trash" data-toggle="tooltip" data-placement="top" title="Delete"></i></a>
                        </td>
                    </tr>
                  @endforeach
                  </tbody>
