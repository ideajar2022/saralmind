                ...
                <table class="table table-bordered">
                  ...
                  @foreach($grades as $key=>$grade)
                    <tr id="table-row-{{ $grade->id }}">
                        ...
                        <td>{{ $grade->status }}</td>
                        <td> 
                          <a href="{{ route('grade.restore',$grade->id)}}" class="badge bg-primary restore-confirm"><i class="fa fa-trash-restore" data-toggle="tooltip" data-placement="top" title="Restore"></i></a>
                          <a href="{{ route('grade.permanent-delete',$grade->id)}}" class="badge bg-danger permanent-delete-confirm"><i class="fa fa-trash" data-toggle="tooltip" data-placement="top" title="Delete"></i></a>
                        </td>
                    </tr>
                  @endforeach
                  </tbody>
