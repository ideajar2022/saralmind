              ...
              <tbody>
                 @foreach($admins as $key=>$admin)
                  <tr id="table-row-{{ $admin->id }}">
                      ...
                      <td>{{ $admin->status }}</td>
                      <td>
                        <a href="{{ route('admin-user.restore',$admin->id)}}" class="badge bg-primary restore-confirm"><i class="fa fa-trash-restore" data-toggle="tooltip" data-placement="top" title="Restore"></i></a>
                        <a href="{{ route('admin-user.permanent-delete',$admin->id)}}" class="badge bg-danger permanent-delete-confirm"><i class="fa fa-trash" data-toggle="tooltip" data-placement="top" title="Delete"></i></a>
                      </td>
                  </tr>
                  @endforeach
                  </tbody>
