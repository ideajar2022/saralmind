                ...
                <table class="table table-bordered">
                  ...
                  @foreach($units as $key=>$unit)
                    <tr id="table-row-{{ $unit->id }}">
                        ...
                        <td>{{ $unit->status }}</td>
                        <td>
                          <a href="{{ route('unit.restore',$unit->id)}}" class="badge bg-primary restore-confirm"><i class="fa fa-trash-restore" data-toggle="tooltip" data-placement="top" title="Restore"></i></a>
                          <a href="{{ route('unit.permanent-delete',$unit->id)}}" class="badge bg-danger permanent-delete-confirm"><i class="fa fa-trash" data-toggle="tooltip" data-placement="top" title="Delete"></i></a>
                        </td>
                    </tr>
                  @endforeach
                  </tbody>
