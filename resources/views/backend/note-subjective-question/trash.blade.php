      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6 text-right">
            <a href="{{route('exercise.create')}}" class="badge bg-success top-add-btn"><i class="fa fa-plus" title="Add Exercise"></i></a>
                ...
                <table class="table table-bordered">
                  ...
                  @foreach($subjectiveQuestions as $key=>$subjectiveQuestion)
                    <tr id="table-row-{{ $subjectiveQuestion->id }}">
                        ...
                        <td>
                          <a href="{{ route('exercise.restore',$subjectiveQuestion->id)}}" class="badge bg-primary restore-confirm"><i class="fa fa-trash-restore" data-toggle="tooltip" data-placement="top" title="Restore"></i></a>
                          <a href="{{ route('exercise.permanent-delete',$subjectiveQuestion->id)}}" class="badge bg-danger permanent-delete-confirm"><i class="fa fa-trash" data-toggle="tooltip" data-placement="top" title="Delete"></i></a>
                        </td>
                    </tr>
                  @endforeach
                  </tbody>
