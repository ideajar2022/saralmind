...
<title>Important Questions | {{ $faculty->name }} | {{ config('app.name', 'Saralmind') }}</title>
        ...
        <div class="row">
            <div class="col-md-9 align-self-center">
                ...
                <div class="inner-title">
                    <h1>Important Questions - {{ $faculty->name }}</h1>
                </div>
            </div>
            <div class="col-md-3">
                ...
                <div class="courses-wrapper p-0 mb-4">
                    ...
                    <div class="row w-100 my-5 justify-content-center">
                        ...
                        <div class="col-sm-12 col-md-3 col-lg-3 text-center">
                            <a href="{{ route('imp-question-subject',[$faculty->program->slug,$faculty->slug,$grade->slug])}}" class="single-course">
