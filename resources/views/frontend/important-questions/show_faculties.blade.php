...
<meta name="title" content="Important Questions By Program" />
...
<title>Important Questions | {{ $program->name }} | {{ config('app.name', 'Saralmind') }}</title>
                ...
                <div class="page-next">
                    <nav aria-label="breadcrumb" class="d-inline-block">
                        <ul class="breadcrumb bg-white rounded shadow mb-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Important Questions</li>
                        </ul>
                    </nav>
                </div>
                ...
                <div class="courses-wrapper p-0 mb-4">
                    ...
                    <div class="row w-100 my-5 justify-content-center">
                        ...
                        <div class="col-sm-12 col-md-3 col-lg-3 text-center">
                            <a href="{{ route('imp-question-grade',[$faculty->program->slug,$faculty->slug])}}" class="single-course">
                                <div class="inner-course-wrap">
                                    <div class="icon-wrapper">
                                        <!-- <i class="fa fa-book" aria-hidden="true"></i> -->
                                        <img src="{{ $faculty->image_url }}">
                                    </div>
                                    <h3>{{ $faculty->name }}</h3>
                                </div>
