...
<title>Important Questions | {{ $grade->name }} | {{ config('app.name', 'Saralmind') }}</title>
                ...
                <div class="page-next">
                    <nav aria-label="breadcrumb" class="d-inline-block">
                        <ul class="breadcrumb bg-white rounded shadow mb-0">
                            ...
                            <!-- <li class="breadcrumb-item" aria-current="page"><a href="{{route('imp-question-grade')}}">{{ $grade->faculty->name }}</a></li> -->
                            <li class="breadcrumb-item active" aria-current="page">{{ $grade->name }}</li>
                        </ul>
                    </nav>
                </div>
                <div class="inner-title">
                    <h1>Important Questions - {{ $grade->name }}</h1>
                </div>
            </div>
            <div class="col-md-3">
                ...
                <div class="courses-wrapper p-0 mb-4">
                    ...
                    <div class="row w-100 my-5 justify-content-center">
                        ...
                        <div class="col-sm-12 col-md-3 col-lg-3 text-center">
                            <a href="{{ route('imp-question-lesson',[$subject->program->slug,$subject->faculty->slug,$subject->grade->slug,$subject->slug])}}" class="single-course">
