                            ...
                            <ul class="nav nav-pills mb-3 d-block" id="pills-tab" role="tablist">
                                <li class="nav-link">
                                    <a data-type="" class="nav-link {{ (request('type') == '') ? 'active':''}}"
                                        ...
                                        aria-selected="{{ (request('type') == '') ? 'true':'false'}}">Note</a>
                                </li>
                                <li class="nav-link">
                                    <a data-type="things-to-remember"
                                        ...
                                        aria-selected="{{ (request('type') == 'things-to-remember') ? 'true':'false'}}">Things
                                        to remember</a>
                                </li>
                                ...
                                <li class="nav-link">
                                    <a data-type="video"
                                        ...
                                        aria-selected="{{ (request('type') == 'video') ? 'true':'false'}}">Videos</a>
                                </li>
                                @endif
                                ...
                                <li class="nav-link">
                                    <a data-type="exercise"
                                        ...
                                        aria-selected="{{ (request('type') == 'exercise') ? 'true':'false'}}">Exercise</a>
                                </li>
                                @endif
                                ...
                                <li class="nav-link">
                                    <a data-type="quiz" class="nav-link {{ (request('type') == 'quiz') ? 'active':''}}"
                                        ...
                                        aria-selected="{{ (request('type') == 'quiz') ? 'true':'false'}}">Quiz</a>
                                </li>
                                @endif
                            </ul>
                        </div>
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade {{ (request('type') == '') ? 'show active':''}} " id="pills-note"
                                ...
                                <div class="note-wrapper">
                                    <!-- <h3 class="title mb-2">{{ $note->title }}</h3> -->

                                    
                                    @php
                                    $content = explode("</p>", substr($note->description,1000),2);

                                    @endphp
                                    

                                    <span style="text-align: justify;">
                                        {!! substr($note->description,0,1000) !!}{!! @$content[0] !!}
                                    </span>
                                    ...
                                    <ins class="adsbygoogle"
                                         ...
                                         data-ad-client="ca-pub-7884450043218320"
                                         data-ad-slot="1463749851"></ins>
                                    <script>
                ...
                <div class="course-sidebar">
                    <div class="course-single-info course-widget">
                        <div class="accordion sidebar-accordion" id="accordionSidebar">
                            ...
                            <!-- {!! cache($note->subject->slug.'_note_sidebar_view') !!} -->
